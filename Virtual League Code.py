'''
This is some code I've written for the Virtual League. 
Feel free to edit it or save a copy, since I have a backup.
Hopefully I have figured out how to allow everyone to edit at once, 
and if so it may be better to have your own copy to test stuff in before adding it to this.

Yet to be done:
- Functions to get and parse input from the camera and ultrasound
- An actual algorithm to follow
- Finalising TURN_CONST and MOVE_CONST so that they work as intended (More information below)
'''
